          ...
          <div class="g2">
            <div class="gadget">
              ...
              <ul class="sb_menu">
				...
				<li><a href="DU_Search_File.jsp">Search File</a></li>
				<li><a href="DU_Request_Trapdoor.jsp">Request Trapdoor</a></li>
				
				<li><a href="DU_Download.jsp">Download File</a></li>
				<li><a href="DU_View_File_Transaction.jsp">View Your Transactions</a></li>
				<li><a href="DU_View_File_Search_Details.jsp">View File Search Details</a></li>
